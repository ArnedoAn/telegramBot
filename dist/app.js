...
bot.onText(/\/mas (.+)/, (msg, match) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (0, operations_1.operation)(resp, 3000);
    if (result.status === "success") {
        yield (0, operations_1.registerOperation)(resp);
...
bot.onText(/\/menos (.+)/, (msg, match) => __awaiter(void 0, void 0, void 0, function* () {
    const chatId = msg.chat.id;
    const resp = parseFloat(match[1]); // the captured "whatever"
    const result = yield (0, operations_1.operation)(resp * -1, 3000);
    if (result.status === "success") {
        yield (0, operations_1.registerOperation)(resp * -1);
...
bot.onText(/\/saldo/, (msg, match) => __awaiter(void 0, void 0, void 0, function* () {
    const chatId = msg.chat.id;
    const result = yield (0, operations_1.getSaldo)();
